...
const QueueItemSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'queueType': PropertySchema(
      ...
      name: r'queueType',
      type: IsarType.byte,
      enumMap: _QueueItemqueueTypeEnumValueMap,
    ),
...
void _queueItemSerialize(
  ...
  writer.writeByte(offsets[2], object.queueType.index);
...
QueueItem _queueItemDeserialize(
  ...
  final object = QueueItem(
    ...
    queueType:
        _QueueItemqueueTypeValueEnumMap[reader.readByteOrNull(offsets[2])] ??
            QueueType.user,
...
P _queueItemDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_QueueItemqueueTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          QueueType.user) as P;
    case 3:
...
const _QueueItemqueueTypeEnumValueMap = {
  'user': 0,
  'playlist': 1,
  'recommendation': 2,
};
const _QueueItemqueueTypeValueEnumMap = {
  0: QueueType.user,
  1: QueueType.playlist,
  2: QueueType.recommendation,
};
...
extension QueueItemQueryFilter
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> addedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> addedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id',
      ));
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> orderEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'order',
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> orderGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> orderLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> orderBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> queueTypeEqualTo(
      QueueType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> queueTypeLessThan(
    QueueType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> queueTypeBetween(
    QueueType lower,
    QueueType upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> sourceIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'source',
      ));
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterFilterCondition> sourceIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'source',
      ));
...
extension QueueItemQuerySortBy on QueryBuilder<QueueItem, QueueItem, QSortBy> {
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> sortByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> sortByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> sortByQueueType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueType', Sort.asc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> sortByQueueTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension QueueItemQuerySortThenBy
  ...
  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> thenByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.asc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> thenByOrderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'order', Sort.desc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> thenByQueueType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueType', Sort.asc);
    });
  }

  QueryBuilder<QueueItem, QueueItem, QAfterSortBy> thenByQueueTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'queueType', Sort.desc);
    });
  }
...
extension QueueItemQueryWhereDistinct
  ...
  QueryBuilder<QueueItem, QueueItem, QDistinct> distinctByOrder() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'order');
    });
  }

  QueryBuilder<QueueItem, QueueItem, QDistinct> distinctByQueueType() {
    return QueryBuilder.apply(this, (query) {
...
extension QueueItemQueryProperty
  ...
  QueryBuilder<QueueItem, int, QQueryOperations> orderProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'order');
    });
  }

  QueryBuilder<QueueItem, QueueType, QQueryOperations> queueTypeProperty() {
    return QueryBuilder.apply(this, (query) {
